...
const data = {
  magento: {
    graphQLApi:
      "https://integration-5ojmyuq-funmyhyypx2zw.ap-3.magentosite.cloud/graphql",
    restApi: {
      url: "https://integration-5ojmyuq-funmyhyypx2zw.ap-3.magentosite.cloud/rest/V1/stockItems/",
  ...
  ms: {
    baseUrl: "https://stg-croissant.ais.th/external/stg",
  ...
  endPoint: {
    ...
    admd: {
      ...
      updateProfile:
        "https://admd-stg.adldigitalservice.com/auth/v3.2/publicId/info",
      sameSite: "None",
    ...
    // aisLogger: "https://stg-croissant.ais.th/external/stg/ncp-logger",
    returnOrClaim: {
      checkClaimFlag:
