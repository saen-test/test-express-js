...
const data = {
  magento: {
    graphQLApi: "https://mcstaging.store.ais.th/graphql",
    restApi: {
      url: "https://mcstaging.store.ais.th/rest/V1/stockItems/",
      token: constant.MAGENTO_REST_AUTH_TOKEN,
    },
  },
  aem: {
    url: constant.APPLICATION_BASE_URL,
    profile: `${constant.APPLICATION_BASE_URL}/content/ais/th/en_us/profile-page.html`,
  },
  log: {
    envName: "uat",
  },
  ms: {
    baseUrl: "https://uat-croissant.ais.th/external/uat",
  ...
  endPoint: {
    ...
    admd: {
      changePassword: "https://admd-stg.adldigitalservice.com/auth/v3.2/changepassword",
      updateProfile: "https://admd-stg.adldigitalservice.com/auth/v3.2/publicId/info",
      sameSite: "None",
      clientId: constant.ADMD_CLIENT_ID,
      login:
        "https://admd-stg.adldigitalservice.com/auth/v3.2/oauth/authorize?response_type=code&client_id=%2FLp1jncN%2F975w7dahFP8V0slzsMyXhwQJmT%2Bxx7BuYlejhgqxNULUw%3D%3D&scope=profile&redirect_uri=https://dev-croissant.ais.th/external/uat/test/user/auth&template_name=ncp&lang=eng&nonce=2022062001445",
    },
    getKYCUrl:
    ...
    // aisLogger: "https://uat-croissant.ais.th/external/uat/ncp-logger",
    returnOrClaim: {
      checkClaimFlag:
        "https://apim-hubcommon-az-asse-dev-001.azure-api.net/mychannel-eclaim-on-prem/api/ncp/checkClaim",
      listBom:
        "https://apim-hubcommon-az-asse-dev-001.azure-api.net/mychannel-eclaim-on-prem/api/ncp/listBom",
      claimOrderDetail:
        "https://apim-hubcommon-az-asse-dev-001.azure-api.net/dev-aftersale-claim/aftersale/api/v1/claimncp/claim-order-detail",
      updateClaimOrder:
        "https://apim-hubcommon-az-asse-dev-001.azure-api.net/dev-aftersale-claim/aftersale/api/v1/claimncp/update-claim-order",
    },
  ...
  nbo: {
    getOffer:
      "https://apim-hubcommon-az-asse-dev-001.azure-api.net/ngcm/mviva_nbo",
    viewOffer:
      "https://apim-hubcommon-az-asse-dev-001.azure-api.net/ngcm/mviva_offer_view_update",
